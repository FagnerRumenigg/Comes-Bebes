...
export const getRegisterResponseMock = (overrideResponse: Partial< CreatedUserResponse > = {}): CreatedUserResponse => ({id: faker.string.uuid(), email: faker.string.alpha({length: {min: 10, max: 20}}), username: faker.string.alpha({length: {min: 10, max: 20}}), displayName: faker.string.alpha({length: {min: 10, max: 20}}), role: faker.helpers.arrayElement(['USER','ADMIN'] as const), ...overrideResponse})
